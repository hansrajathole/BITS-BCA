...
const UpdateProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`http://localhost:3000/product/update/${productId}`, {
        title,
        image,
        description,
        price,
  ...
  return (
    <div className="h-[89vh] w-full flex justify-center items-center mt-16">
      <form
        onSubmit={(e) => {
          handleSubmit(e);
        }}
      ...
      >
        <h1 className="text-center font-semibold text-2xl">Update product</h1>
        <br />
